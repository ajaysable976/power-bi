-- Query to create table and columns for table ipl_matches_2008_2022
...
COPY ipl_matches_2008_2022 FROM 'D:\datascience\almabetter\Pratice\Power-Bi\ipl_matches_2008_2022.csv' DELIMITER ',' CSV HEADER;
...
select count(distinct(city)) from ipl_matches_2008_2022
...
COPY ipl_ball_by_ball_2008_2022 FROM 'D:\datascience\almabetter\Pratice\Power-Bi\ipl_ball_by_ball_2008_2022.csv' DELIMITER ',' CSV HEADER;

-- checking the data
select count(*) from ipl_ball_by_ball_2008_2022
